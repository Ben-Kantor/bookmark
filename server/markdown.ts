import { Marked, TokenizerAndRendererExtension, Tokens } from 'npm:marked@16.1.2'
import { markedSmartypantsLite } from 'npm:marked-smartypants-lite@1.0.3'
import { markedHighlight } from 'npm:marked-highlight@2.2.2'
import markedFootnote from 'npm:marked-footnote@1.4.0'
import hljs from 'npm:highlight.js@11.11.1'
import * as sanitizeHtml from 'npm:sanitize-html@2.12.0'
