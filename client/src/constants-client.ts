...
export const paletteResultsEl = document.getElementById(
...
export const setLastFocusedItem = (item: HTMLElement | null): HTMLElement | null =>
    lastFocusedItem = item
export const setCols = (columns: (HTMLElement | null)[]): (HTMLElement | null)[] => cols = columns
export const setPaletteResults = (results: PaletteResult[]): PaletteResult[] =>
